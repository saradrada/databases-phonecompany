CREATE OR REPLACE PACKAGE pkModificar AS
    ...
    --Función que permite Modificar un cliente en la base de datos. 
    ...
    --Función que permite Modificar un funcionario en la base de datos. 
    ...
    --Función que permite Modificar un Producto en la base de datos. 
    ...
    --Función que permite Modificar una Solicitud en la base de datos. 
    ...
    --Función que permite Modificar un Tipo en la base de datos. 
